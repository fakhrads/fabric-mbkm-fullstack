    ...
    return(
        ...
        <div className="lg:flex bg-white">
            <div className="lg:w-1/2 xl:max-w-screen-sm">
                <div className="py-12 bg-indigo-100 lg:bg-white text-center text-2xl text-indigo-900 font-display font-semibold">
                    <h2 className="text-center text-2xl text-indigo-900 font-display font-semibold">
                      <img width={100} className="mx-auto"/>
                    </h2>
                </div>
                <div className="px-12 bg-white sm:px-24 md:px-48 lg:px-12 xl:px-24 xl:max-w-2xl">
                    <h2 className="text-center text-2xl text-indigo-900 font-display font-semibold">
                      Log in
                    </h2>
                    <div className="mt-12">
                        <form method="post" action="/api/auth/callback/credentials">
                            <div>
                                ...
                                <input className="w-full text-lg text-black py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" 
                                type="email" 
                                placeholder="fakhrads@example.com" 
                            ...
                            <div className="mt-10">
                              ...
                              <button onClick={onSubmit} className="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
